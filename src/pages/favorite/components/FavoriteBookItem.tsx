...
const FavoriteBookItem: React.FC<FavoriteBookItemProps> = ({ book }) => {
    const [isInCart, setIsInCart] = useState(rootStore.cart.contains(book))
    const [isFavorite, setFavorite] = useState(rootStore.favorite.contains(book))
    ...
    const handleAddToFavorite = () => {
        rootStore.favorite.returnBookToDelete(book)
        setFavorite(true)

    }

    const handleDeleteFromFavorite = () => {
        rootStore.favorite.addBookToDelete(book)
        setFavorite(false)
    }
...
export default observer(FavoriteBookItem)
